...
async function main() {
    ...
    // Clean existing skills if needed or just create
    // await prisma.skill.deleteMany(); 
    // Prefer upsert or basic create loop. For seed, createMany is often used after deleteMany
    ...
    const projectsData = [
        {
            ...
            technologies: JSON.stringify(["Node.js", "Express", "MongoDB", "JWT"]), // Storing as JSON string
            category: "backend",
        ...
        },
        {
            ...
            technologies: JSON.stringify(["React", "Next.js", "Chart.js", "Tailwind"]),
            category: "fullstack",
        ...
        },
        {
            ...
            technologies: JSON.stringify(["Python", "CrewAI", "LangChain", "FastAPI"]),
            category: "backend",
        ...
        },
        {
            ...
            technologies: JSON.stringify(["Docker", "Kubernetes", "GitHub Actions", "Terraform"]),
            category: "devops",
        ...
        },
        {
            ...
            technologies: JSON.stringify(["Next.js", "TypeScript", "Tailwind", "Framer Motion"]),
            category: "frontend",
